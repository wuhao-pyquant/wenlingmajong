...
<html lang="zh-CN">
  <head>
    ...
    <link rel="stylesheet" href="/photon_lobby.css?v=20260710-photon-1" />
  </head>
  <body class="standalone-page auth-only-page photon-auth-page">
    ...
    <script src="/photon_scene.js?v=20260710-photon-1" defer></script>
    <script src="/battle_lobby.js?v=20260710-photon-1" defer></script>
  </body>
</html>
```
